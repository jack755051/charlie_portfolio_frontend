...
export const useMockStore = defineStore('mock', () => {
  ...
  const timelineData = ref<ITimeline>({
    ...
    data: [
      ...
      },
      {
        ...
        title: '精誠資訊',
        time: '2024-04',
        content: ['全國公教人員退休撫卹系統'],
      },
      {
        type: 'color-pointer',
        title: '昕力科技',
        time: '2024-07',
        content: ['Systalk.Flow', 'Systalk.Audit', '全球人壽Poc', '微笑單車chatbot', '饗賓chatbot'],
      },
    ],
  })
  /**技術棧 */
  const technologyStack = ref<ITechnologyStack[]>([
    ...
    {
      title: '容器化技術',
      stack: [{ stackName: 'Docker', icon: 'DockerIcon' }],
    },
    {
      title: '狀態管理工具',
      stack: [
    ...
    {
      title: '圖表與視覺化',
      stack: [{ stackName: 'Echart', icon: 'EchartIcon' }],
    },
    {
      title: 'UI 框架',
      stack: [
  ...
  const portfolioPageData = ref<IPortfolio[]>([
    {
      ...
      description:
        '企業級金鑰管理平台，提供 API Key 管理、權限控制及使用統計分析功能。負責昕力科技內部所有產品的金鑰配置與安全管理，確保系統間的安全通訊。',
      role: '前端工程師',
      duration: '2024-07 ~ 至今',
      technologies: [
    ...
    },
    {
      ...
      title: 'Systalk.Audit',
      description:
        '企業級稽核系統，記錄並追蹤系統內所有關鍵操作。提供完整的審計日誌、異常偵測及合規報告功能，確保企業運營的透明度與安全性。',
      role: '前端工程師',
      duration: '2024-07 ~ 至今',
      technologies: [
        { name: 'Angular', icon: 'AngularIcon', category: '前端框架' },
    ...
    },
    {
      ...
      title: '全球人壽 ICR POC',
      description:
        'AI 智慧文件辨識系統 POC 專案，整合 OCR 與 NLP 技術，自動辨識並擷取保險文件中的關鍵資訊。大幅提升理賠審核效率，減少人工輸入錯誤。',
      role: '前端工程師',
    ...
    },
    {
      ...
      description:
        '旅程規劃平台，讓旅行規劃變得像喝水一樣簡單。提供互動式地圖整合、行程管理及逐日行程規劃功能，讓使用者輕鬆安排完美的旅程。',
      role: '前端工程師',
    ...
    },
    {
      ...
      description:
        'Angular 20 企業級 UI 組件庫（Monorepo 架構），提供可重複使用的高品質組件套件，包含表格、分頁、卡片、拖放等多個獨立發布的 npm 套件，建立完整的設計系統。',
      role: '前端工程師 / 組件庫開發者',
