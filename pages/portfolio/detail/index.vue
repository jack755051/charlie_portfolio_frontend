  ...
  <div class="min-h-screen bg-slate-50 relative pb-32">
    ...
    <div v-if="currentProject" class="relative z-10 max-w-7xl mx-auto px-6 pt-6">
      ...
      <div v-if="currentProject.screenshots?.length" class="mb-16 relative group">
        ...
        ></div>
        <div
          class="relative rounded-[1.5rem] overflow-hidden border border-slate-200 shadow-2xl bg-white"
        >
          ...
          <img
            ...
            class="w-full h-auto object-cover max-h-[600px] object-top"
          />
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        <div class="lg:col-span-8 space-y-10">
          ...
          <div
            v-if="currentProject.features?.length || currentProject.achievements?.length"
            class="grid grid-cols-1 md:grid-cols-2 gap-6"
          >
            <div
              v-if="currentProject.features?.length"
            ...
            >
              ...
              <ul class="space-y-3">
                <li
                  v-for="(feat, i) in currentProject.features"
                  :key="i"
            ...
            <div
              v-if="currentProject.achievements?.length"
              class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm"
            >
              <h4 class="font-bold text-slate-800 mb-4 flex items-center gap-2">
              ...
              <ul class="space-y-3">
                <li
                  v-for="(ach, i) in currentProject.achievements"
                  :key="i"
                  class="flex gap-3 text-sm text-slate-600"
                >
          ...
          <div
            v-if="currentProject.screenshots && currentProject.screenshots.length > 1"
            class="space-y-6"
          >
            <h3 class="text-2xl font-bold text-slate-800">Project Gallery</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div
                v-for="(shot, idx) in currentProject.screenshots.slice(1)"
                :key="idx"
