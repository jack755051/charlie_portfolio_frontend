    ...
    <div class="scrollable-content-wrapper h-screen overflow-hidden relative">    
        ...
        <div class="snap-y snap-mandatory h-full overflow-y-scroll scroll-smooth pt-[60px]">
            <!-- 主要內容區塊 -->
             <div class="w-full">
                <!--關於我-區塊-->
                <ScrollSection ref="aboutSection" id="section1" :class="['flex-col gap-[50px] !justify-start']" >
                <template #title>
                ...
                <!--經驗-區塊-->
                <ScrollSection ref="experienceSection" id="section2" :class="['flex-col gap-[50px] !justify-start']">
                <template #title>
                ...
                <ScrollSection ref="aboutInit" id="section3" :class="['flex-col gap-[50px] !justify-start']">
                    <template #title>
                        <div :class="['flex w-full py-6 items-center justify-center']">
                        <p class="underline-title">現有技術棧</p>
                        </div>
                    </template>
                    <template #content>
