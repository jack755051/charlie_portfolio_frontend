  ...
  const experienceData = ref<IExperience[]>([
    {
      ...
      isActive: true,
      description:
        '專注於 AI 對話產品與企業級管理系統的前端開發。負責將複雜的 AI 邏輯轉化為直觀的對話介面，並構建高擴展性的後台架構。',
      projects: [
    ...
    },
    {
      ...
      isActive: false,
      description:
        '擔任主力前端開發，跨足電子書商城、政府標案與系統維運。具備同時維護多個專案並快速切換 context 的能力。',
      projects: [
        '原住民族知識體系',
        '原住民族住宅業務補助系統',
        '台北市公報網',
    ...
    },
    {
      ...
      isActive: false,
      description:
        '透過高強度的集訓，建立紮實的網頁開發基礎，包含 HTML/CSS/JS 核心觀念與框架入門。',
      projects: [],
